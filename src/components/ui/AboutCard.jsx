export const AboutCard = ({ icon, title, description }) => {
  return (
    <div className="w-53 h-72 bg-linear-to-b from-primary-light to-primary rounded-xl flex flex-col items-center text-center text-white shadow-lg transition-all duration-300 hover:-translate-y-2 cursor-default shrink-0">
